            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('action' => 'Members@store')) !!}

                        <div class="form-group has-feedback row {{ $errors->has('first_name') ? ' has-error ' : '' }}">
                            {!! Form::label('first_name', trans('First Name'), array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('first_name', NULL, array('id' => 'first_name', 'class' => 'form-control', 'placeholder' => trans('First Name of Member'))) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('last_name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('last_name', NULL, array('id' => 'last_name', 'class' => 'form-control', 'placeholder' => trans('Last Name of Member'))) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('age') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('age', NULL, array('id' => 'age', 'class' => 'form-control', 'placeholder' => trans('Age of the Member'))) !!}
                        ...
                        {!! Form::button('' . trans('Create New Member'), array('class' => 'btn btn-success btn-flat margin-bottom-1 pull-right','type' => 'submit', )) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
